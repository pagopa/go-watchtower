...
export const finalActionRules: ValidationRule[] = [
  {
    ...
    severity: 'error',
    weight: 2,
    message: "L'azione 'Ho dubbi sulla criticità' richiede una nota conclusiva e almeno un link",
    appliesTo: (a) =>
      a.finalActions.some((fa) => fa.name.includes('Ho dubbi sulla criticità')),
    validate: (a) =>
  ...
  },
  {
    ...
    appliesTo: (a) =>
      a.finalActions.some((fa) => fa.name.includes('richiede una escalation')),
    validate: (a) =>
