...
export const SYSTEM_EVENT_RESOURCE_LABELS: Record<SystemEventResource, string> = {
  ...
  [SystemEventResources.MICROSERVICES]:             'Microservizi',
...
export const SYSTEM_EVENT_ACTION_LABELS: Partial<Record<SystemEventAction, string>> = {
  ...
  [SystemEventActions.MICROSERVICE_CREATED]:        'Microservizio Creato',
  [SystemEventActions.MICROSERVICE_UPDATED]:        'Microservizio Aggiornato',
  [SystemEventActions.MICROSERVICE_DELETED]:        'Microservizio Eliminato',
