...
export type AnalysisOrigin = (typeof AnalysisOrigins)[keyof typeof AnalysisOrigins];
...
> = {
  ...
  NO_RUNBOOK: AutomationExecutionStatuses.SKIPPED,
...
) as [AutomationCancellationFinalizedBy, ...AutomationCancellationFinalizedBy[]];
...
> = {
  ...
  WORKER_CONFIGURATION_ERROR: AutomationFailErrorCategories.WORKER_CONFIGURATION,
